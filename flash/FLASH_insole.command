#!/bin/bash
UF2="/Users/hoanglong/Desktop/necklace-insole/flash/insole.uf2"
echo "============================================"
echo " Flashing: insole.uf2"
echo "============================================"
echo ""
...
RC=$?
echo ""
if [ $RC -eq 0 ]; then echo "Board now advertises as Xiao-insole. Watch the blue LED."; fi
