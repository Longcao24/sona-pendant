#!/bin/bash
UF2="/Users/hoanglong/Desktop/necklace-insole/flash/1_audio_full.uf2"
echo "============================================"
echo " Flashing: 1_audio_full.uf2"
echo "============================================"
echo ""
...
RC=$?
echo ""
if [ $RC -eq 0 ]; then echo "Board running audio firmware. Watch the blue LED."; fi
